...
import { useChat, connectChat, sendMessage } from '../hooks/useChat';
...
const CustomerChatBox: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100]">
      {isOpen ? (
        <div className="bg-white w-80 sm:w-96 h-[500px] shadow-2xl border border-gray-200 rounded-2xl flex flex-col overflow-hidden transform transition-all duration-300">
          {/* Header */}
            ...
            <div className="flex items-center space-x-3">
              <div className="relative">
                ...
                {isConnected ? (
                  ...
                  <div className="absolute bottom-0 right-0 w-2.5 h-2.5 bg-yellow-500 rounded-full border-2 border-black animate-pulse"></div>
                )}
              </div>
              <div>
          ...
          {/* Body */}
          <div ref={scrollRef} className="flex-grow overflow-y-auto p-4 space-y-2 bg-gray-50 flex flex-col">
            {messages.length === 0 && (

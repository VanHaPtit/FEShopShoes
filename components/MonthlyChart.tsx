...
const MonthlyChart: React.FC = () => {
  ...
  return (
    <div className="bg-white p-6 rounded-[2.5rem] shadow-sm border border-gray-100 h-[400px]">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h3 className="text-lg font-black uppercase tracking-widest text-gray-900">Doanh thu theo tháng</h3>

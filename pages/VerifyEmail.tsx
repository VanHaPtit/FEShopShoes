...
const VerifyEmail: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 bg-gray-50">
      <div className="w-full max-w-md bg-white rounded-[2rem] shadow-2xl p-8 border border-gray-100 text-center">
        {status === 'loading' && (
          <div className="flex flex-col items-center">
            <div className="animate-spin rounded-full h-12 w-12 border-t-4 border-b-4 border-black mb-4"></div>
            <h2 className="text-xl font-bold uppercase tracking-widest text-gray-800">Đang xử lý...</h2>
        ...
        {status === 'error' && (
          <div className="flex flex-col items-center animate-in zoom-in duration-300">
            ...
            <button
              onClick={() => navigate('/')}
              className="w-full py-4 bg-gray-200 text-black font-bold uppercase text-sm tracking-widest hover:bg-gray-300 transition-all active:scale-[0.98]"
            >
              Về trang chủ
            </button>
          </div>

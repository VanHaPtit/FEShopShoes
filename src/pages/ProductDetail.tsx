...
//                   ${activeImage === img ? 'border-[#0F172A] opacity-100' : 'border-transparent opacity-60 hover:opacity-100'}`}
//               >
...
//                     ${selectedSize === size ? 'bg-black text-white border-[#0F172A]' : 'border-[#E2E8F0] hover:border-[#0F172A]'}`}
//                 >
//                   {size}
//                 </button>
//               ))}
...
//                       ${selectedColor === color ? 'bg-black text-white border-[#0F172A]' : 'border-[#E2E8F0] hover:border-[#0F172A]'}
...
//                 <div className="flex border border-[#0F172A] h-9"> {/* Chuyển từ border-2 sang border để thanh mảnh hơn */}
//                   <button
...
//                   <div className="w-10 flex items-center justify-center font-bold text-sm border-x border-[#0F172A]">
//                     {quantity}
//                   </div>
...
//                 <span>Giới tính:</span> <span className="text-[#0F172A]">{product.gender}</span>
//                 <span>Chất liệu:</span> <span className="text-[#0F172A]">{product.material}</span>
//                 <span>Đế giày:</span> <span className="text-[#0F172A]">{product.soleType}</span>
//                 <span>Xuất xứ:</span> <span className="text-[#0F172A]">{product.origin}</span>
//               </div>
//             </div>
        ...
        <div className="lg:col-span-6 h-fit space-y-6">
          ...
          <div className="pt-2">
            <div className="flex justify-between items-center mb-3">
              ...
              <button className="text-[11px] text-[#5a2d2d] underline font-medium hover:text-[#0F172A]">Size Guide</button>
            </div>
            <div className="flex flex-wrap gap-3">
              {Array.from(new Set(variants.map(v => v.size))).sort((a, b) => Number(a) - Number(b)).map(size => (
                <button

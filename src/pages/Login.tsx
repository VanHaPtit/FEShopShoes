...
//                   required
//                   className="w-full pl-10 pr-4 py-3 bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all text-[#0F172A]"
//                 />
//               </div>
//             </div>
...
//                   required
//                   className="w-full pl-10 pr-12 py-3 bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all text-[#0F172A]"
//                 />
//                 <button
//                   type="button"
...
//           {/* Footer Section */}
//           <div className="mt-8 pt-6 border-t border-[#E2E8F0] flex flex-col items-center space-y-4">

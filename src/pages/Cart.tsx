...
//               Tổng cộng: <span className="text-[#0F172A] font-black">{formatCurrency(finalAmount)}</span>
//             </p>
//           </div>
...
//                 ${selected === option.id ? 'border-white/30 bg-white/20' : 'border-[#E2E8F0] bg-[#F8FAFC]'}`}>
//                 {option.icon}
//               </div>
...
//                   ${allChecked || someChecked ? 'bg-black border-[#0F172A]' : 'bg-white border-gray-300 hover:border-[#0F172A]'}`}

    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h2 className="text-2xl font-black text-[#0F172A] tracking-tight">Quản lý Banner</h2>
                    <p className="text-sm text-gray-500 font-medium mt-1">Danh sách các banner hiển thị trên trang chủ</p>
                </div>
                <button
                    onClick={() => handleOpenModal()}
                    className="flex items-center gap-2 bg-[#2563EB] text-white px-5 py-2.5 rounded-xl text-sm font-bold shadow-lg shadow-blue-500/30 hover:bg-[#1D4ED8] transition-all"
                >
                    <Plus size={18} />
                    THÊM BANNER
                </button>
